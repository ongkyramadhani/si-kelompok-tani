                  ...
                  <div class="row">
                    ...
                    <div class="col-4">
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="kesimpulan" id="" placeholder="Kesimpulan Monitoring">
                      </div>
                    </div>
                    <div class="col-8">
                      <div class="form-group">
                ...
                <div class="card-body">
                  <div class="row">
                    ...
                    <div class="col-4">
                      <div class="form-group">
                        <label for="">Kesimpulan Monitoring</label>
                        <input type="text" class="form-control" name="kesimpulan" value="<?=$row['kesimpulan']?>">
                      </div>
                    </div>
                    <div class="col-8">
                      <div class="form-group">

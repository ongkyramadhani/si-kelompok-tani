...
$sql = mysqli_query($koneksi, "SELECT * FROM kelompok_tani INNER JOIN wilayah_binaan ON kelompok_tani.id_w=wilayah_binaan.id_w INNER JOIN ketua ON kelompok_tani.id_ke=ketua.id_ke INNER JOIN pegawai ON kelompok_tani.id_pegawai=pegawai.id_pegawai");
...
case "ubah": 
 $id_k  = $_GET['id_k'];
  $tb_dt = mysqli_query($koneksi,"SELECT * FROM kelompok_tani INNER JOIN wilayah_binaan ON kelompok_tani.id_w=wilayah_binaan.id_w INNER JOIN pegawai ON kelompok_tani.id_pegawai=pegawai.id_pegawai INNER JOIN ketua ON kelompok_tani.id_ke=ketua.id_ke WHERE id_k = '$id_k'");
                  ...
                  <div class="row">
                    ...
                    <div class="col-4">
                      <div class="form-group">
                        <label for="">Nama Ketua</label>
                        <select name="id_ke" class="form-control" required="">
                              <option value="<?=$row['id_ke']?>"><?=$row['nama']?></option>
                              <?php 
                                $sss = mysqli_query($koneksi, "SELECT * FROM ketua");
                                    while($data = mysqli_fetch_array($sss)) {?>
                                    <option name="id_ke" value="<?= $data['id_ke'] ?>"><?= $data['nama'] ?></option>
...
if (isset($_POST['edit'])) {
    ...
    $ubah = mysqli_query($koneksi,"UPDATE kelompok_tani SET id_w='$id_w',id_ke='$id_ke',nama_k='$nama_k',alamat_k='$alamat_k',tahun_k='$tahun_k',unggulan='$unggulan',id_pegawai='$id_pegawai',tgl_k='$now' WHERE `kelompok_tani`.`id_k`='$id_k'");
if($ubah){

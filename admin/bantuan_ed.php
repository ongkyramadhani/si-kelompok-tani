                      ...
                      <div class="form-group">
                        <label for="">Cari Pengajuan (Berdasarkan Pengajuan yang Sudah Disetujui Atasan)</label>
                          <select name="id_p" class="form-control"  onchange='changeValue(this.value)' required="">
                              <option value="<?=$row['id_p']?>">Nama Ketua :<?=$row['nama']?> | <?=$row['nama_k']?></option>
                              <?php 
                                $sss = mysqli_query($koneksi, "SELECT * FROM pengajuan INNER JOIN user ON pengajuan.id_user=user.id_user INNER JOIN kelompok_tani ON pengajuan.id_k=kelompok_tani.id_k INNER JOIN ketua ON kelompok_tani.id_ke=ketua.id_ke INNER JOIN wilayah_binaan ON kelompok_tani.id_w=wilayah_binaan.id_w");
                  ...
                  <div class="row">
                    ...
                    <div class="col-4">
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="jenis_b" id="" value="<?=$row['jenis_b']?>">
                      </div>
                    </div>
                  </div>
                  <div class="row">

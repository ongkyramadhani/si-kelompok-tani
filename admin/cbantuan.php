  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Cetak Data Surat Bantuan KT</h1>
          </div>
          <div class="col-sm-6">
          ...
          <div class="col-md-3">
            <div class="card">
              <div class="card-header">
                <div class="card-body">
                  <form action="../dt/data_bantuan.php" method="post" >
                    <table>
                      <label class="form-label" >Berdasarkan Wilayah</label>
                        <div class="" style="margin-bottom: 10px;">
                          <?php $awe = mysqli_query($koneksi, "SELECT * FROM bantuan INNER JOIN pengajuan ON bantuan.id_p=pengajuan.id_p INNER JOIN pegawai ON bantuan.id_pegawai=pegawai.id_pegawai INNER JOIN kelompok_tani ON pengajuan.id_k=kelompok_tani.id_k INNER JOIN ketua ON kelompok_tani.id_ke=ketua.id_ke INNER JOIN wilayah_binaan ON kelompok_tani.id_w=wilayah_binaan.id_w GROUP BY kel ASC");?>
            ...
            <div class="card">
              <div class="card-header">
                <div class="card-body">
                  <form action="../dt/data_bantuan.php" method="post" >
                    <table>
                      <label class="form-label">Berdasarkan Kelompok</label>
                          <div class="" style="margin-bottom: 10px;">
                          <?php $ewe = mysqli_query($koneksi, "SELECT * FROM bantuan INNER JOIN pengajuan ON bantuan.id_p=pengajuan.id_p INNER JOIN pegawai ON bantuan.id_pegawai=pegawai.id_pegawai INNER JOIN kelompok_tani ON pengajuan.id_k=kelompok_tani.id_k INNER JOIN ketua ON kelompok_tani.id_ke=ketua.id_ke INNER JOIN wilayah_binaan ON kelompok_tani.id_w=wilayah_binaan.id_w GROUP BY nama_k ASC");?>
                ...
                <div class="card-body">
                  <form action="../dt/data_bantuan.php" method="post"> 
                    <table>
                        ...
                        <label class="form-label">Berdasarkan Tahun Input Surat</label>
                          <div class="" style="margin-bottom: 10px;">
                            <select name="tahun-cetak" class="form-control" required>
                              <?php
                                $ahay = mysqli_query($koneksi, "SELECT DISTINCT YEAR(tgl_b) as tahun FROM bantuan ORDER BY tahun DESC");
                      ...
                      <a name="cetak" title="Cetak Semua Data" href="../dt/data_bantuan.php?id_k=<?php echo $row['id_k']; ?>" class="btn btn-dark" target="_blank"><i class="fas fa-check-double"></i></a>
                    </div>
                  </form>
                </div>
                <!-- /.card-body -->

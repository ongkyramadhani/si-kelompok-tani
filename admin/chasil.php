          ...
          <div class="col-md-3">
            <div class="card">
              <div class="card-header">
                <div class="card-body">
                  <form action="../dt/data_hasil.php" method="post" >
                    <table>
                      <label class="form-label">Berdasarkan Kelompok Tani</label>
                          <div class="" style="margin-bottom: 10px;">
                          <?php $ewe = mysqli_query($koneksi, "SELECT * FROM hasil INNER JOIN kelompok_tani ON hasil.id_k=kelompok_tani.id_k INNER JOIN wilayah_binaan ON kelompok_tani.id_w=wilayah_binaan.id_w GROUP BY nama_k ASC");?>
                ...
                <div class="card-body">
                  <form action="../dt/data_hasil.php" method="post"> 
                    <table>
                        ...
                        <label class="form-label">Berdasarkan Tahun Input Surat</label>
                          <div class="" style="margin-bottom: 10px;">
                            <select name="tahun-cetak" class="form-control" required>
                              <?php
                                $ahay = mysqli_query($koneksi, "SELECT DISTINCT YEAR(tgl_awal) as tahun FROM hasil ORDER BY tahun DESC");
                      ...
                      <a name="cetak" title="Cetak Semua Data" href="../dt/data_hasil.php?id_k=<?php echo $row['id_k']; ?>" class="btn btn-dark" target="_blank"><i class="fas fa-check-double"></i></a>
                    </div>
                  </form>
                </div>
                <!-- /.card-body -->

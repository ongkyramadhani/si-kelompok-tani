...
<head>
  ...
  <!-- Google Font chart : Source Sans Pro -->
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="jual.php" class="nav-link">
                  <i class="fas fa-shopping-cart nav-icon"></i>
                  <p>Penjualan Hasil Tani</p>
                </a>
              </li>
            </ul>
          </li>
          ...
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="canggota.php" class="nav-link">
                  <i class="fas fa-users nav-icon"></i>
                  <p>Anggota Kelompok Tani</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="ckelompok.php" class="nav-link">
                  <i class="fas fa-globe nav-icon"></i>
                  <p>Kelompok Tani</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="cpengajuan.php" class="nav-link">
                  <i class="fas fa-file-invoice-dollar nav-icon"></i>
                  <p>Pengajuan Bantuan Kelompok Tani</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="cbantuan.php" class="nav-link">
                  <i class="fas fa-hand-holding-usd nav-icon"></i>
                  <p>Surat Bantuan Kelompok Tani</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="cmonitoring.php" class="nav-link">
                  <i class="fas fa-eye nav-icon"></i>
                  <p>Monitoring Bantuan KT</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="chasil.php" class="nav-link">
                  <i class="fas fa-seedling nav-icon"></i>
                  <p>Hasil Tani</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="crealisasi.php" class="nav-link">
                  <i class="fas fa-money-check-alt nav-icon"></i>
                  <p>Realisasi Anggaran</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="cjual.php" class="nav-link">
                  <i class="fas fa-shopping-cart nav-icon"></i>
                  <p>Penjualan Hasil Tani</p>
                </a>
              </li>

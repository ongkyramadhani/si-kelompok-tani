                      ...
                      <div class="form-group">
                        <label for="">Nama yang Mengajukan</label>
                          <select name="id_user" class="form-control" required="">
                              <option value="<?= $user_row['id_user'] ?>"><?= $user_row['nama_u'] ?>/<?= $user_row['level'] ?></option>
                          </select>
                      </div>
                    </div>
                    <div class="col-4">
                      <div class="form-group">
                        <label for="">Nama Kelompok & Ketua</label>
                          <select name="id_k" class="form-control" required="">
                            ...
                            <?php 
                              $sss = mysqli_query($koneksi, "SELECT * FROM kelompok_tani LEFT JOIN ketua ON kelompok_tani.id_ke=ketua.id_ke");
...
if (isset($_POST['input'])) {
    ...
    $tambah = mysqli_query($koneksi,"INSERT INTO pengajuan (id_user,  id_k, keperluan_p,anggaran,file_p,tgl_p,ket_p,status_p) VALUES(
          '$id_user',
          '$id_k',
          '$keperluan_p',
          '$anggaran',

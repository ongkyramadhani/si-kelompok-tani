...
<head>
  ...
  <title>Data Anggota Kelompok Tani</title>
  ...
  <tbody>
    ...
    <tr>
      <td><h5>Perihal</h5></td>
      <td>:</td>
      <td><h5>Seluruh Data Anggota Kelompok Tani</h5></td>
    </tr>
  </tbody>
</table>
  ...
  <br>
      ...
      if (isset($_POST['cetak'])) {
        ...
        $result = mysqli_query($koneksi, "SELECT * FROM anggota INNER JOIN kelompok_tani ON anggota.id_k=kelompok_tani.id_k WHERE nama_k = '$nama_k' ORDER BY nama_k ASC");
        
      }else{
        $result = mysqli_query($koneksi, "SELECT * FROM anggota INNER JOIN kelompok_tani ON anggota.id_k=kelompok_tani.id_k");
      }
      if(mysqli_num_rows($result)==0) {
        echo '<script>alert("Data Tidak Ada !"); window.location.href="../admin/canggota.php";</script>';
        
      }

?>
  <div class="container">
  <h2 class="text-center">DAFTAR ANGGOTA KELOMPOK TANI </h2>

...
switch($action){ default:
  $id_ke=$user_row['id_ke'];
$sql = mysqli_query($koneksi, "SELECT * FROM anggota INNER JOIN kelompok_tani ON anggota.id_k=kelompok_tani.id_k WHERE id_ke = '$id_ke'");
                  ...
                  <div class="row">
                    <div class="col-4">
                      <div class="form-group">
                        <label for="">Nama Kelompok Tani Anda</label>
...
if (isset($_POST['input'])) {
    ...
    $tambah = mysqli_query($koneksi,"INSERT INTO anggota (id_ke,id_k,nik, nama_a,tempat_lahir,tgl_lahir,alamat,no_hp,jabatan) VALUES(
          '$id_ke',
          '$id_k',
          '$nik',
          '$nama_a',

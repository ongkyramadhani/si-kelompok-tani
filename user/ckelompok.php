          ...
          <div class="col-md-4">
            ...
            <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">Cetak Data Kelompok Tani</h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
                <div class="card-body">
                  ...
                  <form action="../dt/data_kelompok.php" method="post" target="_blank"> 
                    <table>
                        ...
                        <label class="form-label">Berdasarkan Tahun</label>
                          <div class="" style="margin-bottom: 10px;">
                            <select name="tahun-cetak" class="form-control">
                              ...
                              <option><?php $formatwaktu = $row["tgl_k"];echo date('Y',strtotime($formatwaktu)); ?></option>
                              <?php } ?>
                              <?php } ?>
                            </select>
                          </div>

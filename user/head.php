...
if (!isset($_SESSION['id_ke']) || (trim($_SESSION['id_ke']) == '')) { ?>
<script>
window.location = "../";
</script>
<?php 
}
$session_id=$_SESSION['id_ke'];

$user_query = mysqli_query($koneksi, "SELECT * FROM ketua WHERE id_ke = '$session_id'")or die(mysqli_error($koneksi));
    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <br>
          <li class="nav-header">Input&Cetak</li>
          <li class="nav-item">
            <a href="kelompok.php" class="nav-link">

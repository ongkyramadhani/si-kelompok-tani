                      ...
                      <div class="form-group">
                        <label for="">Cari Pengajuan (Berdasarkan Pengajuan yang Sudah Disetujui Atasan)</label>
                          <select name="id_p" class="form-control"  onchange='changeValue(this.value)' required="">
                              ...
                              <?php 
                                $sss = mysqli_query($koneksi, "SELECT * FROM pengajuan INNER JOIN user ON pengajuan.id_user=user.id_user INNER JOIN kelompok_tani ON pengajuan.id_k=kelompok_tani.id_k INNER JOIN wilayah_binaan ON kelompok_tani.id_w=wilayah_binaan.id_w WHERE status_p = 'Disetujui'");
...
if (isset($_POST['input'])) {
    ...
    $tambah = mysqli_query($koneksi,"INSERT INTO bantuan (id_p,  id_pegawai, jenis_b,jumlah_b,tgl_b) VALUES(
          '$id_p',
          '$id_pegawai',
          '$jenis_b',
          '$jumlah_b',
